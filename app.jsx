    ...
    <div className="site">
      ...
      <section className="v3-page-hero">
        ...
        <div className="v3-page-hero__inner">
          <span className="v3-overline v3-page-hero__overline">Consumer and community engagement</span>
          <h1 className="v3-page-hero__title">Engagement that moves beyond consultation and influences <b>decisions</b></h1>
          <p className="v3-page-hero__lead">Designing, strengthening, and embedding meaningful consumer and community engagement across health, research, and rare disease.</p>
...
function setupReveal() {
  ...
  const sels = ['.offer__portrait', '.offer__panel', '.offer__item', '.voices', '.teaser__head', '.teaser__grid .ins-card',
    '.v3-cta', '.contact__intro', '.contact__card', '.v3-foot'];
  const els = [];
  sels.forEach((s) => document.querySelectorAll(s).forEach((e) => els.push(e)));
  if (!els.length) return;
  const EASE = 'cubic-bezier(0.22,1,0.36,1)';
  const staggerSels = ['.teaser__grid .ins-card', '.offer__item'];
  els.forEach((e) => {
    e.style.opacity = '0';
