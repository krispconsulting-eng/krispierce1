...
function Nav({ onNav, theme = 'hero', active }) {
  ...
  return (
    <header className={`site-nav site-nav--${theme}`}>
      <Logo href="index.html#home" inverse={theme === 'hero'} />
  ...
  return (
    <section className="hero" id="home">
      <div className="hero__media">
        <image-slot id="kp-hero" shape="rect" fit="cover" position="50% 38%"
        src="assets/bush-path.jpg"
        placeholder="Drop a warm portrait of Kris"></image-slot>
        <div className="hero__scrim"></div>
      </div>
      <Nav onNav={onNav} />
      <div className="hero__inner">
        <Pill variant="glass" dot>Healthcare engagement</Pill>
        <h1 className="hero__title" style={{ width: "700px" }}>Insights. Patient-centred outcomes. Flexible methodology. Together, we discover <em>what works</em></h1>
        <p className="hero__sub">Most organisations know they need to involve the people their work affects. Fewer know how to do it so the involvement actually changes the outcome.

That gap is where the work happens.</p>
        <p className="hero__sub hero__sub--2">Health organisations, industry partners, and not-for-profits come here to turn consumer
          and community engagement into something that holds up: research that surfaces what people actually need, co-design
          that produces decisions people can live with, and insights that stand up to scrutiny.</p>
        <div className="hero__proof">
          <span className="hero__proof-label" style={{ fontWeight: "700" }}>Partnered with teams across</span>
          <div className="hero__sectors" style={{ width: "700px" }}>
      ...
      <div className="about__grid">
        ...
        <div className="about__right">
          <div className="about__photo">
            <image-slot id="kp-about" shape="rounded" radius="22" fit="cover" position="50% 22%"
            src="assets/kris-portrait.jpg"
