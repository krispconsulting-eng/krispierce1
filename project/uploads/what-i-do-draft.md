# What I Do Page Draft — krispierce.com.au

*Draft for review. Nothing published. Reworked to option 4: openings lead with the work and the outcome.*

---

## What I Do

This isn't a service menu. Every brief is different, and the method follows the question. What follows are examples of the work and the outcomes it's built for. If your challenge doesn't fit neatly into one of these, that's usually a sign we should talk.
...
Most engagements begin with a conversation about the challenge, not the method. I'll tell you whether I can help and what approach fits. [Link: Let's talk.]

---

## Notes for Kris (not page copy)

- This page barely used "I" to begin with; option 4 just removed the two that crept in. Reads as work-first now.
- Five examples, framed as work not services, each with the what/who/outcome shape.
- Industry Support carries the MA Code line, consistent with homepage and About.
- **SEO title:** *What I Do | Kris Pierce Consulting*
